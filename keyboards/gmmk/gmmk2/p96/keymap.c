...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {  
	...
	[1] = LAYOUT( //Spacebar   
        ...
        KC_TAB,     KC_4,             KC_5,       KC_6,       KC_R,           /**/ KC_T,   KC_Y,     KC_U,     KC_I,     KC_O,       KC_P,       KC_LBRC,    KC_RBRC,    KC_BSLS,                /**/ KC_P7,     KC_P8,     KC_P9,     KC_PPLS,
        KC_CAPS,    KC_7,             KC_8,       KC_9,       KC_F,           /**/ KC_G,     KC_H,     KC_J,     KC_K,     KC_L,       KC_SCLN,    KC_QUOT,    KC_ENT,                             /**/ KC_P4,     KC_P5,     KC_P6, 
    ...
    [3] = LAYOUT( //FN Key                       
        ...
        KC_CAPS,    KC_A,             KC_S,       KC_D,       KC_F,           /**/ KC_G,     KC_H,     KC_J,     KC_K,     KC_L,        KC_SCLN,   KC_QUOT,    KC_ENT,                             /**/ KC_P4,     KC_P5,     KC_P6,
        KC_LSFT,    KC_Z,             KC_X,       KC_C,       KC_V,           /**/ RGB_TOG,  KC_N,     KC_M,     KC_COMM,  KC_DOT,      KC_SLSH,   KC_RSFT,                RGB_SPI,                /**/ RGB_M_P,   KC_P2,     KC_P3,    KC_PENT,
